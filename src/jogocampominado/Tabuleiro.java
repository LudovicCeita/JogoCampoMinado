...
/**
 *
 * @author Notorius B.I.G esquadrao suicida
 */
public class Tabuleiro {
    ...
    public boolean ganhou() {
        int count = 0;
        for (int line = 1; line < TAMANHO; line++) {
            for (int column = 1; column < TAMANHO; column++) {
    ...
    //Para mostra campo que ja foram exibidos 
    public void mostrarCampoExibido(int linha, int coluna) {
    ...
    public boolean setPosicao() {
        ...
        do {
            ...
            mostrarCampoExibido(linha, coluna);
